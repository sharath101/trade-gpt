...
class DhanMarketFeed(Template) :
    def __init__(self, analyser):
        ...
        self.instruments = [(1, "1476")]
        self.subscription_code = marketfeed.Ticker
    ...
    async def parse(self, instance, data):
        if data and 'security_id' in data and 'LTP' in data and 'LTT' in data:
...
#         update_candles(data)
#         if engulfingStrategy.engulfing_strategy():
